...
- **L'ORDRE EST CELUI DE L'ARTICLE.** L'accroche, puis la provenance (`source · âge · puces`), puis le résumé — et l'en-tête de l'article rend l'accroche, puis la provenance, puis sa prose. Un objet, un ordre de lecture, qu'on regarde la porte ou qu'on soit dans la pièce (`AC-TITLE-2`).
  - ⚠️ **La ligne meta ouvrait la carte** jusqu'ici, donc les deux se contredisaient : la carte commençait par « Competitors · 2h ago » et l'article par l'accroche. Deux coûts, et le second est le vrai : un lecteur qui balaie la file devait traverser une ligne de caption avant chaque accroche, et cette ligne est **identique sur toutes les cartes du feed** aujourd'hui — `competitor-posts` est la seule source live — donc l'œil relisait onze caractères douze fois pour atteindre la seule ligne qui diffère. Mettre l'accroche en tête donne aussi la chute de graisse lu/non-lu à la **première** ligne de la carte plutôt qu'à la deuxième.
  - Le kebab **reste** dans le coin haut-droit et ne suit pas la ligne meta : c'est l'affordance de la carte, à l'endroit où toutes les cartes de l'app en gardent une. Ce qui a bougé est l'ordre du **contenu**, la seule chose qu'un lecteur compare entre les deux surfaces. Sa gouttière est passée du corps à la **seule ligne** qui la longe, donc la ligne meta et le résumé récupèrent toute la mesure — et les puces atteignent enfin le vrai bord droit.
...
**L'en-tête, c'est le haut de la carte.** Le titre, puis la ligne de provenance **partie pour partie** celle de la carte — badge, source, `· âge`, puis les puces d'état — puis les verbes sur leur propre rang. Les puces ne sont **pas** poussées au bord droit ici, contrairement au feed : le panneau est une colonne unique et une puce seule collée à droite se lirait comme un élément du rang de boutons juste en dessous. Et la ligne tient **la hauteur d'une puce** qu'il y en ait une ou non, sinon l'en-tête changerait de hauteur d'un Topic à l'autre — ce pour quoi les deux faits en sont sortis.
