...
- **La liste** : le batch se lit comme un calendrier éditorial, dans **une seule liste encadrée** (filet grey-20, rayon carte), avec des filets entre les lignes. Les lignes sont **triées par date**. Chaque ligne se lit **QUOI → QUAND** : le post à gauche, sa date à droite, puis le ✕ dans une colonne à lui. Toutes les cellules prennent la hauteur de la ligne et centrent leur contenu, pour que des lignes de hauteurs différentes gardent une même médiane. Le post est à gauche parce que c'est l'objet qu'on reconnaît avant de décider quand il part. Les dates à droite forment une colonne qu'on relit d'un coup d'œil, juste au-dessus du primaire. La chronologie reste portée par le tri.
  ...
  - ⚠️ La date était à gauche, sur une cellule teintée, avec la miniature au milieu de la ligne et absente des posts sans média : les lignes _« flottaient un peu »_. D'où l'inversion QUOI → QUAND, la miniature en tête et toujours présente, et le centrage vertical.
