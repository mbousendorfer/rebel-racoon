...
| **Brand** (Image Generator) | L'ADN de marque du générateur d'images autonome (flag `sexySquirrel`) | **Ce n'est pas un Playbook, par décision** (2026-09-25) : le module ne lit ni n'écrit aucun objet d'Archie. Il a ses propres marques, avec des sous-marques qui héritent d'un parent — ce que §1 interdit aux Playbooks, et qui ne vaut que dans le module. Voir [`FEATURES.md`](FEATURES.md) §18. |
