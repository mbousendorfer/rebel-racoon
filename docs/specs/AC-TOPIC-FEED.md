...
| ID           | Title                                                       | Criterion                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| ------------ | ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `AC-FILT-1`  | Two filter groups, both multi-select                        | Two groups, in this order: **Topic status** (all six states, each with the count of Topics carrying it) and **Sources**. Both let you pick several. The state counts are unfiltered — they describe the feed, so they stay still while the reader ticks. They are also where the two segments' counts went.                                                                                                                                                                                |
