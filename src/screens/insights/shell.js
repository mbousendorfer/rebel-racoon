...
import { html, raw } from "../../utils.js?v=1076";
import { renderTopbar } from "../../components/topbar.js?v=1076";
import { subscribe as subscribeContexts, updateContext } from "../../contexts-store.js?v=1076";
import {
  subscribe as subscribeScope,
  getActivePlaybook,
  getActivePlaybookId,
  setActivePlaybook,
} from "../../active-playbook.js?v=1076";
...
import { consumeHandoff } from "../../handoff.js?v=1076";
import { open as openObjectiveModal } from "../../components/objective-modal.js?v=1076";
import { openObjectiveInChat, repurposePostInChat } from "../../objective-flow.js?v=1076";
import { renderEmptyState } from "../../components/empty-state.js?v=1076";
import { playbookTitle } from "./pieces.js?v=1076";
import { objectiveEntries, playbookRollup, entryByKey } from "./model.js?v=1076";
import { destroyChartsIn, reflowChartsIn } from "./charts.js?v=1076";
import { DEFAULT_LAYOUT, readLayoutId, writeLayoutId, layoutById } from "./views.js?v=1076";
