...
import * as report from "./layouts/report.js?v=1093";
import * as cockpit from "./layouts/cockpit.js?v=1093";
import * as cockpitBis from "./layouts/cockpit-bis.js?v=1093";
import * as mobIndex from "./layouts/mob_index.js?v=1093";
import * as mobSide from "./layouts/mob_side.js?v=1093";
import * as mobBand from "./layouts/mob_band.js?v=1093";
