...
import { playbookTitle, objectiveTitle, objectiveActions, esc } from "../pieces.js?v=1248";
import { mountCharts } from "../charts.js?v=1248";
import { readLede, readNotice, readMeasures, readPosts, readFacts } from "../read.js?v=1248";
