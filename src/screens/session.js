import { html, raw, escapeHtml, escapeAttr as escapeHtmlAttr } from "../utils.js?v=1025";
import { navigate } from "../router.js?v=1025";
import { renderTopbar } from "../components/topbar.js?v=1025";
import { socialAccounts, chatStarters, connectorDocs } from "../mocks.js?v=1025";
import {
...
} from "../social-profiles.js?v=1025";
import { FORMATS, formatsForNetwork, defaultFormatFor, clipFormatItems } from "../clip-formats.js?v=1025";
import { CLIP_SUBTITLE_ITEMS, CLIP_SUBTITLE_LABEL } from "../clip-subtitles.js?v=1025";
import { getSessionById, getSessions, subscribe as subscribeSessions } from "../sessions-store.js?v=1025";
import { getContextById, getContexts, getDefaultContext, updateContext } from "../contexts-store.js?v=1025";
import { revokedContextFor, usableContexts, canView } from "../playbook-access.js?v=1025";
import { isNewUser } from "../user-mode.js?v=1025";
import {
  getThread,
  sendMessage,
  postAssistantChoice,
...
} from "../assistant.js?v=1025";
import { iconFor as fileIconForKind } from "../file-kinds.js?v=1025";
import { getSources, getIdeas, extractVideoIdeas } from "../library.js?v=1025";
import { wireLibraryActions, renderSourcesBulkBar, renderIdeasBulkBar } from "../library-actions.js?v=1025";
import {
...
} from "../composer-mentions.js?v=1025";
import { getPosts, addPostDraft, setSubtitleStyle, subscribe as subscribePostsStore } from "../posts-store.js?v=1025";
import { startDraftFlow, executeDraft, executeDraftBatch, getAnglesForIdea } from "../draft-flow.js?v=1025";
...
import {
  ...
  TOP_POSTS_LIMIT,
} from "../components/top-post-card.js?v=1025";
import { getTopPost } from "../top-posts-store.js?v=1025";
import { renderEmptyState } from "../components/empty-state.js?v=1025";
import * as sidebarWizard from "../sidebar-wizard.js?v=1025";
import * as inlineQuestion from "../inline-question.js?v=1025";
import * as clipStudio from "../clip-studio.js?v=1025";
import * as batchStudio from "../batch-studio.js?v=1025";
import { askConnector } from "../connector-ask.js?v=1025";
import { getConnectedConnectors, findConnector, setConnectorStatus } from "../connectors-store.js?v=1025";
import { renderConnectorLogo } from "../connectors-view.js?v=1025";
import {
  getActiveConnector,
  clearActiveConnector,
  subscribe as subscribeComposerConnector,
} from "../composer-connector.js?v=1025";
import { isFlagOn } from "../feature-flags.js?v=1025";
import * as contextBuilder from "../context-builder.js?v=1025";
import { renderPicker } from "./_analyse-common.js?v=1025";
import { renderSourceCard } from "../components/source-card.js?v=1025";
import { renderIdeaCard } from "../components/idea-card.js?v=1025";
import { renderCompactIdeaCard } from "../components/idea-card-compact.js?v=1025";
import {
  contentState,
  renderContentWorkspace as renderSharedContentWorkspace,
  rerenderContentWorkspaceBody,
  renderContentEmptyState,
} from "../components/content-workspace.js?v=1025";
import { open as openVideoClipsModal } from "../components/video-clips-modal.js?v=1025";
import { open as openChatPickerModal } from "../components/chat-picker-modal.js?v=1025";
import { open as openAddSourceModal } from "../components/add-source-modal.js?v=1025";
import { open as openConnectorsModal } from "../components/connectors-modal.js?v=1025";
import { dropzoneHTML } from "../components/dropzone.js?v=1025";
import {
  classifyFile,
  startFileUpload,
  startUrlImport,
  ...
  setSourceIdeaCount,
} from "../sources-stream.js?v=1025";
import { renderClipCard } from "../components/clip-card.js?v=1025";
import { onFeedbackClick } from "../components/feedback-control.js?v=1025";
...
} from "../components/right-panel.js?v=1025";
import { setHandoff, consumeHandoff } from "../handoff.js?v=1025";
import { attachTopicToChat, useTopicInChat, TOPIC_CHAT_HANDOFF } from "../topic-flow.js?v=1025";
import { getFeedForPlaybook } from "../topic-feeds-store.js?v=1025";
import { getFreshTopics, countFresh, subscribe as subscribeTopics } from "../topics-store.js?v=1025";
import { findTopicSource } from "../topics-catalog.js?v=1025";
import { renderTopicCard } from "../components/topic-card.js?v=1025";
import { openTopicPicker, openTopicArticle } from "../components/topic-picker-modal.js?v=1025";
import { parseHashParams, setHashQuery } from "../url-state.js?v=1025";
import { updateLoadingWatchdog, stopThinkingTimer } from "./session/thinking-chip.js?v=1025";
import { startIntakeLifecycle } from "./session/intake-lifecycle.js?v=1025";
import { rebindWizardKeyboard } from "./session/wizard-keyboard.js?v=1025";
...
import {
  ...
  renderResultCard,
} from "./session/thread-turns.js?v=1025";
