...
import { getSessions, getSessionById, subscribe as subscribeSessions } from "../sessions-store.js?v=1085";
import { getSources, getIdeas } from "../library.js?v=1085";
import { getPosts } from "../posts-store.js?v=1085";
import { parseHashParams, setHashQuery } from "../url-state.js?v=1085";
import { closePanel as closeRightPanel } from "../components/right-panel.js?v=1085";
import { navigate, getPath } from "../router.js?v=1085";
import { setHandoff } from "../handoff.js?v=1085";
import { open as openConfirmModal } from "../components/confirm-modal.js?v=1085";
...
import {
  ...
  accessLabel,
  isMine,
} from "../playbook-access.js?v=1085";
import { isWorkspaceMode, getActivePlaybookId, setActivePlaybook, catalogueRoute } from "../active-playbook.js?v=1085";
import { open as openShareModal } from "../components/share-playbook-modal.js?v=1085";
import { installMoreMenu } from "../components/more-menu.js?v=1085";
...
import { ownerOf } from "../playbook-access.js?v=1085";
...
function bind(root) {
  root.addEventListener("click", (event) => {
    ...
    if (dupBtn) {
      ...
      if (copy) {
        import("../components/toast.js?v=1085").then(({ showToast }) => showToast("Playbook duplicated"));
    ...
    if (delBtn) {
      ...
      if (getContexts().length <= 1) {
        import("../components/toast.js?v=1085").then(({ showToast }) =>
      ...
      openConfirmModal({
        ...
        onConfirm: () => {
          ...
          import("../components/toast.js?v=1085").then(({ showToast }) => showToast("Playbook deleted"));
        },
      });
      return;
    }
