...
import { isWorkspaceMode, setActivePlaybook, catalogueRoute } from "../active-playbook.js?v=1084";
import { mount, snapshotEditable } from "../playbook-view.js?v=1084";
...
import { open as openAnalyzeProfilesModal } from "../components/analyze-profiles-modal.js?v=1084";
import { open as openFillDocumentModal } from "../components/fill-document-modal.js?v=1084";
import { analyzeWebsite, analyzeDocument, analyzeSocialProfiles } from "../context-mock-analysis.js?v=1084";
import { sectionPatchFromAnalysis } from "../context-builder.js?v=1084";
import {
  canView,
  canEdit,
  canDelete,
...
function toast(msg) {
  import("../components/toast.js?v=1084").then(({ showToast }) => showToast(msg));
}
