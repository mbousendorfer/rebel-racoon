...
import { initTopbar, renderTopbar } from "./components/topbar.js?v=301";
...
import { init as initImageStudio } from "./components/image-studio-v2/index.js?v=72";
...
import { renderTopics } from "./screens/topics.js?v=70";
