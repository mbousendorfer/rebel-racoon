...
import { init as initRightPanel } from "./components/right-panel.js?v=460";
...
import { init as initImageStudio } from "./components/image-studio-v2/index.js?v=107";
...
import { renderSession } from "./screens/session.js?v=558";
