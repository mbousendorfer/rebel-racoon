...
import { init as initRightPanel } from "./components/right-panel.js?v=467";
...
import { init as initImageStudio } from "./components/image-studio-v2/index.js?v=114";
...
} from "./components/right-panel.js?v=467";
