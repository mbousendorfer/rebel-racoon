...
import * as imageGenerationMock from "./mock/image-generation.mock.js?v=1235";
import * as copyMock from "./mock/copy.mock.js?v=1235";
import * as ideasMock from "./mock/ideas.mock.js?v=1235";
import * as storage from "./storage.js?v=1235";
...
export { buildPrompt } from "./prompt.js?v=1235";
