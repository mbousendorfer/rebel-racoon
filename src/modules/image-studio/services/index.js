...
import * as imageGenerationMock from "./mock/image-generation.mock.js?v=1307";
import * as copyMock from "./mock/copy.mock.js?v=1307";
import * as ideasMock from "./mock/ideas.mock.js?v=1307";
import * as editMock from "./mock/edit.mock.js?v=1307";
import * as productMock from "./mock/product.mock.js?v=1307";
import * as storage from "./storage.js?v=1307";
...
export { buildPrompt } from "./prompt.js?v=1307";
