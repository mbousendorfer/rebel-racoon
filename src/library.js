...
import { ideasBySession as seedIdeasBySession, allSeedSessions as seedRecentSessions } from "./mocks.js?v=76";
...
import { postExtractionResult, startPending, finishPending } from "./assistant.js?v=80";
import { setIdeasReader } from "./assistant.js?v=80";
