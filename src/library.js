...
import { ideasBySession as seedIdeasBySession, allSeedSessions as seedRecentSessions } from "./mocks.js?v=72";
...
import { postExtractionResult, startPending, finishPending } from "./assistant.js?v=77";
import { setIdeasReader } from "./assistant.js?v=77";
