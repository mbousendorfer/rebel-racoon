...
import { ideasBySession as seedIdeasBySession, allSeedSessions as seedRecentSessions } from "./mocks.js?v=71";
...
import { postExtractionResult, startPending, finishPending } from "./assistant.js?v=76";
import { setIdeasReader } from "./assistant.js?v=76";
