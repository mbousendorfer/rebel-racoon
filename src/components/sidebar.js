...
import { canView, visibleContexts } from "../playbook-access.js?v=8";
...
import { closePanel as closeRightPanel } from "./right-panel.js?v=476";
import { clearSession as clearAssistantSession } from "../assistant.js?v=79";
