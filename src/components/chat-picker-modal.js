...
import { recentSessions } from "../mocks.js?v=76";
import { getSources } from "../sources-stream.js?v=72";
...
import { renderPicker, bindWizardKeyboard, unbindWizardKeyboard } from "../screens/_analyse-common.js?v=56";
