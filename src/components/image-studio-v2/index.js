...
import { requestOpen, notifyClose, bindOverlayDismissal } from "../../modal-coordinator.js?v=1004";
...
import { MODAL_ID, KEY, ctx, state, autosize } from "./context.js?v=1004";
import { loadImg } from "../../image-studio-canvas.js?v=1004";
import { renderStudio } from "./stage-view.js?v=1004";
import { offerUndoIfNeeded, resetUndoOffers } from "./prompt-guard.js?v=1004";
import { bindStudioEvents } from "./events.js?v=1004";
