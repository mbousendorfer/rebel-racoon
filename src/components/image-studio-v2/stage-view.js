...
import { composer } from "./composer-view.js?v=1006";
import { setupStage } from "./setup-stage.js?v=1006";
import { toolPalette } from "./tools-view.js?v=1006";
import { promptGuardDialog } from "./prompt-guard.js?v=1006";
import { editCanvas } from "./edit-view.js?v=1006";
