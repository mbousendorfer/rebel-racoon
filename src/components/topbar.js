import { html, raw, escapeHtml, escapeAttr } from "../utils.js?v=1228";
...
} from "./right-panel.js?v=1228";
import { getSources as getSessionSources, subscribeSources } from "../sources-stream.js?v=1228";
import { getThread, subscribe as subscribeThread } from "../assistant.js?v=1228";
import { getIdeas, subscribe as subscribeLibrary } from "../library.js?v=1228";
import { getPosts, subscribe as subscribePosts } from "../posts-store.js?v=1228";
import {
  isEnabled as isStatusCardEnabled,
  toggle as toggleStatusCard,
  subscribeVisibility as subscribeStatusCardVisibility,
} from "./conversation-status-card.js?v=1228";
import { getSessionById, updateSession, subscribe as subscribeSessions } from "../sessions-store.js?v=1228";
...
import { getActivePlaybook, isWorkspaceMode, isAccountScope, catalogueRoute } from "../active-playbook.js?v=1228";
import { getFeedForPlaybook } from "../topic-feeds-store.js?v=1228";
import { findCadence } from "../topics-catalog.js?v=1228";
import {
  getPickerState as getTopPostsState,
  subscribePicker as subscribeTopPosts,
  backToProfiles as topPostsBackToProfiles,
} from "../top-posts-flow.js?v=1228";
...
import { readLayoutId, viewSwitch } from "../screens/insights/views.js?v=1228";
...
export function initTopbar() {
  ...
  el.addEventListener("click", (event) => {
    ...
    if (event.target.closest("[data-topbar-welcome-alt-exit]")) {
      import("./confirm-modal.js?v=1228").then(({ open }) => {
        open({
